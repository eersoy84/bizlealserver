...
// router.post('/facebookLogin', authFacebook(), authController.facebookLogin);
router.post('/forgotpassword', validate(authValidation.forgotPassword), authController.forgotPassword);
router.post('/updatepassword', auth(), validate(authValidation.updatePassword), authController.updatePassword);
router.post('/send-verification-email', auth(), authController.sendVerificationEmail);
router.post('/verify-email', validate(authValidation.verifyEmail), authController.verifyEmail);

// router.get('/updatepassword', (req, res) => {
//     const x = req.header['token']
//     res.send('ok')
// })
